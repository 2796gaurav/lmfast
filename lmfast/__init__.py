...
def train(
    ...
    **kwargs,
    ...
    training_config = TrainingConfig(output_dir=output_dir, max_steps=max_steps)
    ...
    trainer = SLMTrainer(
        model_config=model_config, training_config=training_config, use_unsloth=use_unsloth
    )
...
def distill(
    student: str, teacher: str, dataset: Any, output_dir: str = "./distilled_model", **kwargs
) -> Any:
    """

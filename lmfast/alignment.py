...
from lmfast.core.models import load_tokenizer
...
class PreferenceTrainer:
    ...
    def __init__(self, model_name: str, config: TrainingConfig, method: str = "orpo"):
    ...
    def train(self, dataset: Any, output_dir: str):
        ...
        if self.method.lower() != "orpo":
            raise NotImplementedError(
                "Currently only ORPO (Odds Ratio Preference Optimization) is supported as it is SOTA for SLMs."
            )
...
def align(
    model: str, dataset: Any, output_dir: str = "./aligned_model", method: str = "orpo", **kwargs
) -> PreferenceTrainer:
    """
